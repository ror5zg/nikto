...
漫画を描く際の参考にしようとコマ割りや構図も少し模写したりしていました。こういった模写をやってみると毎回驚くのですが、構成等に注目せず普段通り漫画を読んでいる際はほとんどコマ割りの構成が頭に残っていません。意識を集中しなければ見えない透明な枠のようです。コマそのものへ意識を向けさせず、コマ自身の機能（画面・構図の描画、時間の流れの表現）を果たしているという意味では理想的なあり方と言えるような気がします。
